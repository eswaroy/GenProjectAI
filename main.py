...
# Custom CSS for professional styling with wider roadmap expander
st.markdown("""
    <style>
    ...
    /* Increase width of the roadmap expander */
    .st-expander {
        width: 100% !important;
        max-width: 1200px !important; /* Wider than typical content width */
    }
    .st-expander > div {
        width: 100% !important;
    }
